                            ...
                            <div class="col-12">
                              <div div class="form-group row">
                                <div class="col-sm-4 col-form-label">
                                  <label for="fak_kode"><strong>Kode Pelaksana </strong></label>
                                </div>
                                <div class="col-sm-8">
                                  <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="fak_kode" class="form-control" name="fak_kode"
                                      placeholder="Isikan dengan Nama Pelaksana" value="<?= $row['fak_kode']?>" />
                                  </div>
                                </div>
                              </div>
                              <div class="form-group row">
                                <div class="col-sm-4 col-form-label">
                                  <label for="fak_nama"><strong>Nama Pelaksana </strong></label>
                                </div>
                                <div class="col-sm-8">
                                  <div class="input-group input-group-merge">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" id="fak_nama" class="form-control" name="fak_nama"
                                      placeholder="Isikan dengan Nama Pelaksana" value="<?= $row['fak_nama']?>" />
                                  </div>
                                </div>
                              </div>
                              <div class="form-group row">
                ...
                <div div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" id="fak_kode" class="form-control" name="fak_kode"
                        placeholder="Isikan dengan Kode Pelaksana" />
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" id="fak_nama" class="form-control" name="fak_nama"
                        placeholder="Isikan dengan Nama Pelaksana" />
                    </div>
                  </div>
                </div>
                <div class="form-group row">
