                ...
                <tr>
                  ...
                  <td style="text-align:center ;">
                    ...
                    <a href="#" type="button" class="open_modal btn btn-outline-danger round btn-sm" data-toggle="modal"
                      data-target="#deleteEmployeeModal<?php echo $hasil['id_unit']; ?>">Hapus</a>
                  </td>
                </tr>
                <!-- MODAL EDIT -->
                <div class="modal fade text-left modal-success" id="edit<?php echo $hasil['id_unit']; ?>" tabindex="-1"
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="unit_nama"
                                      value="<?= $row['unit_nama']?>" placeholder="Isikan dengan nama Unit" />
                                  </div>
                                </div>
                              </div>
                              <div class="form-group row">
                    ...
                    <div class="modal-content">
                      <form method="post" action="unit_act.php">
                        <?php
												...
												while ($row = mysqli_fetch_array($query_edit)) {  
												?>
                        <input type="hidden" class="form-control" value="<?php echo $hasil['id_unit']; ?>"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" id="unit_nama" class="form-control" name="unit_nama"
