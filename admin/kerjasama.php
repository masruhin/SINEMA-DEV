              ...
              <table id="dataTables" class="table table-striped">
                ...
                <tbody>
                  <?php 
                    ...
                    FROM
                      kerjasama a
                      LEFT JOIN negara n ON n.id_negara = a.id_negara
                  ...
                  <tr>
                    ...
                    <td style="text-align:center ;">
                      <button type="button" class="open_modal btn btn-sm btn-relief-primary round" data-toggle="modal"
                        data-target="#view<?php echo $hasil['id_kerjasama']; ?>">Lihat</button>
                      <a class="btn btn-sm btn-relief-info round"
                        href="kerjasama_edit.php?id_kerjasama=<?php echo $hasil['id_kerjasama']?>"
                        role="button">Edit</a>
                      <button type="button" class="open_modal btn btn-sm btn-relief-danger round" data-toggle="modal"
                        data-target="#deleteEmployeeModal<?php echo $hasil['id_kerjasama']; ?>">Hapus</button>
                      <!--<a href="#" type="button"-->
                                    ...
                                    <div class="card-header">
                                      ...
                                      <div class="card-body list-group-item" id="accordionTwo">
                                        <div class="row">
                                            <div class="col-12">
                                            <div class="mb-1">
                                              <P class="form-label" for="first-name-icon">Tingkat Kerjasama</P>
                                              <div class="input-group mb-1">
                                                <div class="input-group-prepend">
                                                  <span class="input-group-text"><i data-feather="flag"></i></span>
                                                </div>
                                                <input type="text" class="form-control"
                                                  value="<?php echo $hasil['negara_kat']?>" readonly />
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-12">
                                            <div class="mb-1">
                                              <P class="form-label" for="first-name-icon">Negara</P>
                                              <div class="input-group mb-1">
                                                <div class="input-group-prepend">
                                                  <span class="input-group-text"><i data-feather="flag"></i></span>
                                                </div>
                                                <input type="text" class="form-control"
                                                  value="<?php echo $hasil['negara_nama']?>" readonly />
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-12">
                                          ...
                                          <div class="col-12">
                                            <div class="mb-1">
                                              <P class="form-label" for="fak_nama">Pelaksana</P>
                                              <div class="input-group ">
                                    ...
                                    <div class="card-header">
                                      <div class="card-body list-group-item" id="accordionTwo">
                                        <div class="row">
                                          ...
                                          <div class="col-12">
                                            <div class="mb-1">
                                              <P class="form-label" for="bkerja_nama">Manfaat / Hasil yang
                                                diperoleh</P>
                                              <div class="input-group ">
                                                <span class="input-group-text"><i data-feather="calendar"></i></span>
                                                <input type="text" id="bkerja_nama" class="form-control"
                                                  value="<?php echo $hasil ['bkerja_nama'];?>" name="bkerja_nama"
                                                  readonly />
                                              </div>
                                            </div>
                                          </div>
