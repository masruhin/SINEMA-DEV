          ...
          <div class="card-body table-responsive">
            <table id="dataTables" class="table table-striped">
              ...
              <tbody>
                ...
                <!-- MODAL EDIT -->
                <div class="modal fade text-left modal-success" id="edit<?php echo $hasil['id']; ?>" tabindex="-1"
                                ...
                                <div class="col-sm-9">
                                  <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="negara"
                                      value="<?= $row['negara_nama']?>" placeholder="Isikan dengan nama Negara" />
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" id="negara_nama" class="form-control" name="negara_nama"
