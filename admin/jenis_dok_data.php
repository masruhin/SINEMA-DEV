            ...
            <table id="dataTables" class="table table-striped">
              ...
              <tbody>
                ...
                <div class="modal-size-lg d-inline-block">
                  <div class="modal fade text-left" id="edit<?php echo $hasil['id_jenis_dok']; ?>" tabindex="-1"
                                  ...
                                  <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                      ...
                                      <input type="text" id="jenis_dok" class="form-control" name="jenis_dok"
                                        placeholder="Isikan dengan nama Jenis Dokumen Kerjasama"
                                        value="<?= $row['jenis_dok']?>" />
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="col-sm-9">
                                    <div class="input-group input-group">
                                      <textarea class="form-control" id="" name="jenis_ket" colspan="4" rows="3"
                                        placeholder="Keterangan Jenis Dokumen Kerjasama"><?= $row['jenis_ket']?>
                                                      </textarea>
                                    </div>
                                  </div>
                                </div>
