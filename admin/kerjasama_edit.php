      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            FROM
              kerjasama a
              LEFT JOIN bentuk_kerjasama f ON f.id_bkerja = a.id_bkerja
              LEFT JOIN negara e ON e.id_negara = a.id_negara
              ...
              // echo '</pre>';
              // die();
              $negara_kat      = $data['negara_kat'];
              $pendidikan      = $data['pendidikan'];
              $penelitian      = $data['penelitian'];
              $pkm      = $data['pkm'];
              $fak      = $data['id_fak'];
              $unit     = $data['id_unit'];
              $bentuk     = $data['id_bkerja'];
                        ...
                        <div class="col-md-6 col-12 mb-1">
                          <div class="form-group row">
                            <label for="colFormLabel" class="col-sm-4 col-form-label"> <span
                                ...
                                style="background-color: rgb(255 205 21 / 83%); height:25px; color: #020202 !important;">Jaringan
                                Negara</span></label>
                            <div class="col-sm-8">
                              <select name="negara_kat" class="select2 form-control" tabindex="-1">
                                <option value="<?php echo $negara_kat;?>">
                                  <?php echo $negara_kat;?>
                                </option>
                                <option>
                                  LOKAL
                          ...
                          <div class="form-group row">
                            <label for="colFormLabel" class="col-sm-4 col-form-label"><span
                                class="badge badge-pill badge-light-success mr-1 lg"
                                style="background-color: rgb(255 205 21 / 83%); height:25px; color: #020202 !important;">Negara</span></label>
                            <div class="col-sm-8">
                              <select name="id_negara" class="select2 form-control" tabindex="-1">
                                <option value="<?php echo $data['id_negara'];?>">
                                  <!-- <?php echo $data['id_negara'] ." | ". $data['fak_nama']; ?> -->
                                  <?php echo $data['negara_nama']; ?>
                                </option>
                                ...
                                <option value="<?php echo $data2['id_negara'] ?>">
                                  <?php echo $data2['id_negara'] ." | ". $data2['negara_nama']; ?>
                                </option>
                          ...
                          <div class="form-group row">
                            <label for="colFormLabel" class="col-sm-4 col-form-label"><span
                                class="badge badge-pill badge-light-success mr-1 lg"
                                style="background-color: rgb(255 205 21 / 83%); height:25px; color: #020202 !important;">Bentuk
                                Kerjasama</span></label>
                            <div class="col-sm-8">
                              <select name="id_bkerja" class="select2 form-control" tabindex="-1">
                                <option value="<?php echo $data['id_bkerja'];?>">
                                  <?php echo $data['bkerja_nama']; ?>
                                </option>
                                <option disabled>-- Pilh untuk mengganti --</option>
                                <?php include 'config.php';
                                $sql2  		= "SELECT * FROM bentuk_kerjasama";                        
                                $query2  	= mysqli_query($kon, $sql2);
                                while ($data2 = mysqli_fetch_array($query2)){?>
                                <option value="<?php echo $data2['id_bkerja'] ?>">
                                  <?php echo $data2['bkerja_nama']; ?>
                                </option>
                                <?php }
                                ?>
                              </select>
                              ...
                              <div class="demo-inline-spacing">
                                <div class="custom-control custom-control-info custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="colorCheck2" value="1"
                                    name="pendidikan" <?php if ($pendidikan==1) {
                                        echo 'checked';
                                      };?> />
                                ...
                                <div class="custom-control custom-control-primary custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="colorCheck1" value="1"
                                    name="penelitian" <?php if ($penelitian==1) {
                                        echo 'checked';
                                      };?> />
