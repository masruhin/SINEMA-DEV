      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Laporan Kerjasama <strong>FEB Bisnis Digital</strong></h4>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($hasil['dok']!=0) {?>
                    <button
                      onclick="JavaScript:window.location.href='download_feb_lapker_bisdig.php?dok=<?php echo $hasil['dok']?>';"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="POST" action="lapker_feb_bisdig_act.php" enctype="multipart/form-data">
                            <!-- <form class="form form-horizontal" action="galeri_act.php" method="POST"> -->
                            <?php
                              $id = $hasil['id']; 
                              // $query_edit = mysqli_query($kon, "SELECT * FROM lapker_feb_bisdig WHERE id='$id'");
                ...
                <div id="deleteEmployeeModal<?php echo $hasil['id']; ?>" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form method="post" action="lapker_feb_bisdig_act.php">
                        <?php
                                  $id = $hasil['id']; 
                                  $query_edit = mysqli_query($kon, "SELECT * FROM lapker_feb_bisdig WHERE id='$id'");
    ...
    <div class="modal fade text-left" id="add" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="POST" action="lapker_feb_bisdig_act.php" enctype="multipart/form-data"
              id="myForm">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
