  ...
  if (isset($_POST['upload'])) {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
        if($ukuran < 304407000){ 
            ...
            $query    = mysqli_query($kon, "INSERT INTO web (judul,deskripsi,wa,telpon,email,alamat,instagram,gambar) 
                                            VALUES('$judul','$deskripsi','$wa','$telpon','$email','$alamat','$instagram','$nama')");
            // var_dump($query);
            // die();
            if($query){
