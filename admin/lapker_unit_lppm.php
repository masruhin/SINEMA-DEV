      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Laporan Kerjasama <strong>Unit LP2M</strong></h4>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($hasil['dok']!=0) {?>
                    <button
                      onclick="JavaScript:window.location.href='download_unit_lppm.php?dok=<?php echo $hasil['dok']?>';"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="POST" action="lapker_unit_lppm_act.php" enctype="multipart/form-data">
                            <!-- <form class="form form-horizontal" action="galeri_act.php" method="POST"> -->
                            <?php
                              $id = $hasil['id']; 
                              // $query_edit = mysqli_query($kon, "SELECT * FROM lapker_unit_perpus WHERE id='$id'");
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <select class="select3 form-control" name="unit" id="unit" required>
                                  <option value="">--unit--</option>
                                  <?php
                                  include 'config.php';
                                $unit = mysqli_query($kon,"select * from unit");
                                while($f = mysqli_fetch_array($unit)){
                                  ?>
                                  <option value="<?php echo $f['id_unit'] ?>"><?php echo $f['unit_nama']; ?>
                                  </option>
                                  <?php
                                    }
                                    ?>
                ...
                <div id="deleteEmployeeModal<?php echo $hasil['id']; ?>" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form method="post" action="lapker_unit_lppm_act.php">
                        <?php
                                  $id = $hasil['id']; 
                                  $query_edit = mysqli_query($kon, "SELECT * FROM lapker_unit_lppm WHERE id='$id'");
    ...
    <div class="modal fade text-left" id="add" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="POST" action="lapker_unit_lppm_act.php" enctype="multipart/form-data"
              id="myForm">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
