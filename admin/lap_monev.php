            ...
            <table id="dataTables" class="table table-striped">
              ...
              <tbody>
                <?php 
											include "config.php";
											$no = 1;
											$data = mysqli_query($kon, "SELECT id, tahun_lap, YEAR(date_created) as tahun,judul,dok FROM lap_monev ORDER BY id ASC");
											if (!$data) {
												printf("Error: %s\n", mysqli_error($kon));
												exit();
											}
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="POST" action="lap_monev_act.php" enctype="multipart/form-data">
                            <!-- <form class="form form-horizontal" action="galeri_act.php" method="POST"> -->
                            <?php
                              $id = $hasil['id']; 
                              $query_edit = mysqli_query($kon, "SELECT * FROM lap_monev WHERE id='$id'");
                ...
                <div id="deleteEmployeeModal<?php echo $hasil['id']; ?>" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form method="post" action="lap_monev_act.php">
                        <?php
                                  $id = $hasil['id']; 
                                  $query_edit = mysqli_query($kon, "SELECT * FROM lap_monev WHERE id='$id'");
    ...
    <div class="modal fade text-left" id="add" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="POST" action="lap_monev_act.php" enctype="multipart/form-data"
              id="myForm">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
