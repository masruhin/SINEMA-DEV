      ...
      <div class="content-wrapper container-xxl p-0">
                ...
                <table id="dataTables" class="table table-striped">
                  ...
                  <tbody>
                    <?php 
											include "includes/config.php";
											$no = 1;
											$data = mysqli_query($kon, "SELECT * FROM lap_kinerja ORDER BY id ASC");
											if (!$data) {
												printf("Error: %s\n", mysqli_error($kon));
												exit();
											}
        ...
        <div class="row match-height">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Laporan Kepuasan Mitra</h4>
              </div>
              <div class="card-body table-responsive">
                <table id="dataTables" class="table table-striped">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>judul Lap Kepuasan Mitra</th>
                      <th>Nama Dokumen</th>
                      <th>File</th>
                      <th>Tanggal Di Upload</th>
                    </tr>
                  ...
                  <tbody>
                    <?php 
											include "includes/config.php";
											$no = 1;
											$data = mysqli_query($kon, "SELECT * FROM lap_kep_mitra ORDER BY id ASC");
											if (!$data) {
												printf("Error: %s\n", mysqli_error($kon));
												exit();
											}
        ...
        <div class="row match-height">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Laporan MONEV</h4>
              </div>
              <div class="card-body table-responsive">
                <table id="dataTables" class="table table-striped">
                  <thead>
                  ...
                  <tbody>
                    <?php 
											include "includes/config.php";
											$no = 1;
											$data = mysqli_query($kon, "SELECT * FROM lap_monev ORDER BY id ASC");
											if (!$data) {
												printf("Error: %s\n", mysqli_error($kon));
												exit();
											}
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if ($hasil['dok']!=0) {?>
                        <button
                          onclick="JavaScript:window.location.href='download_lap_monev.php?dok=<?php echo $hasil['dok']?>';"
                          class="btn btn-outline-dark round btn-sm">Download</button>
                        <?php }else{ ?>
                        <span class="badge badge-pill badge-light-danger mr-1 lg">Tidak ada file!</span>
                        <?php }
                ...
                <table id="dataTables" class="table table-striped">
                  ...
                  <tbody>
                    <?php 
											include "includes/config.php";
											$no = 1;
											$data = mysqli_query($kon, "SELECT * FROM lap_kerjasama ORDER BY id ASC");
											if (!$data) {
												printf("Error: %s\n", mysqli_error($kon));
												exit();
											}
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if ($hasil['dok']!=0) {?>
                        <button
                          onclick="JavaScript:window.location.href='download_lap_kerjasama.php?dok=<?php echo $hasil['dok']?>';"
                          class="btn btn-outline-dark round btn-sm">Download</button>
                        <?php }else{ ?>
                        <span class="badge badge-pill badge-light-danger mr-1 lg">Tidak ada file!</span>
                        <?php }
