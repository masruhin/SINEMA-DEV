              ...
              <div class="card-body">
                <div class="meetup-header d-flex align-items-center">
                  ...
                  <div class="my-auto">
                    ...
                    <img src="./assests/images/SINEMA.png" alt="" height="60%" width="50%">
              ...
              <div class="card-header">
                ...
                <div class="card-body list-group-item" id="accordionTwo">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="colFormLabel" name="no_ref_kerjasama"
                        placeholder="Normal Input" / value="<?php echo $hasil["email"];?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="colFormLabel" name="wa" placeholder="Normal Input" /
                        value="<?php echo $hasil["wa"];?>" readonly>
                    </div>
                  </div>
