...
<html>
  ...
  <head>
    ...
    <title>Daftar Akun - SINEMA</title>
    ...
    <div class="container">
      <div class="d-flex justify-content-center h-100">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" name="theform" action="registration_act.php">
              ...
              <div class="input-group form-group">
                ...
                <input type="text" class="form-control" id="fullname" type="text" name="fullname"
                  placeholder="Isi nama lengkap anda" required autofocus>
              </div>
              <div class="input-group form-group">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i data-feather='check'></i></span>
          ...
          <div class="card-footer">
            ...
            <div class="d-flex justify-content-center links">
              <span style="font-size:8pt;color:black">Sudah memiliki Akun?<a href="login.php"
