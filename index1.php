...
<div class="app-content content ">
  ...
  <div class="content-wrapper container-xxl p-0">
    <div class="content-body">
      ...
      <section id="dashboard-ecommerce">
        <div class="row match-height">
          ...
          <div id="carousel-wrap" class="carousel slide col-lg-12 col-12" data-ride="carousel">
    ...
    color: #020202 !important;">
              ...
              <span class="badge badge-pill badge-light-success mr-1 lg" style="background-color: rgb(255 205 21 / 83%);
    color: #020202 !important;">'.$row['deskripsi'].'</span>
      ...
      <div class="row">
        <div class="col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <canvas id="grafik_cat" style="height: 400px"></canvas>
              </div>
            </div>
          </div>
      </div>
              ...
              <table id="dataTables" class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php 
                    if ($hasil['negara_kat']=='DALAM NEGERI') {?>
                    ...
                    <?php }?>
                    <?php 
                    if ($hasil['negara_kat']=='LUAR NEGERI') {?>
                    <td style="text-align:center;">
                      <i data-feather='check'></i>
                    </td>
                    <?php }else{ ?>
